  ...
  preflights: [
    {
      getCSS: () => `
        *, ::before, ::after {
          /* Normalize browser defaults before directional border utilities run.
           * Without this reset, border-solid activates the browser's medium
           * width on every unspecified edge, turning a 1px divider into a
           * three-sided 3px frame. */
