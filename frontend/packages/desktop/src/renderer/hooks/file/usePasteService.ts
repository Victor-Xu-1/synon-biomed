...
import { getClipboardFiles, PasteService } from '@/renderer/services/PasteService';
...
export const usePasteService = ({
  ...
  const handlePaste = useCallback(
    ...
    [conversation_id, source, supportedExts, onFilesAdded, onBrowserFilesAdded, onTextPaste, imageCounter, t]
  );
