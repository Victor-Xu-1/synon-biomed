...
const artifactIndexMock = vi.hoisted(() => ({
  current: {
    byFilename: new Map<string, unknown>(),
    byArtifactId: new Map<string, unknown>(),
    byVersionId: new Map<string, unknown>(),
  },
}));
...
vi.mock('@/renderer/pages/conversation/Messages/artifacts', () => ({
  useConversationArtifactIndex: () => artifactIndexMock.current,
}));
...
describe('MarkdownViewer', () => {
  ...
  it('keeps remote links as browser anchors', () => {
    render(<MarkdownViewer content='[docs](https://synon-ai.com/docs)' />);
    ...
    render(
      <MarkdownViewer
        ...
        companionArtifactUrls={{
          'curve.png':
            '/api/artifacts/11111111-1111-4111-8111-111111111111/versions/22222222-2222-4222-8222-222222222222',
          'results.csv':
            '/api/artifacts/33333333-3333-4333-8333-333333333333/versions/44444444-4444-4444-8444-444444444444',
        }}
      />
    );

    await waitFor(() => {
      expect(screen.getByRole('img', { name: 'curve' })).toHaveAttribute(
        'src',
        '/api/artifacts/11111111-1111-4111-8111-111111111111/versions/22222222-2222-4222-8222-222222222222'
      );
    });
