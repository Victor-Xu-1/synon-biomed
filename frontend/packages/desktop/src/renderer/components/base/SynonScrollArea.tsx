 ...
 * <SynonScrollArea className="h-400px">
 *   <div>Content...</div>
 * </SynonScrollArea>
 *
 * // 水平滚动 / Horizontal scroll
 * <SynonScrollArea direction="x" className="w-400px">
 *   <div className="whitespace-nowrap">Content...</div>
 * </SynonScrollArea>
 *
 * // 双向滚动 / Both directions
 * <SynonScrollArea direction="both" className="h-400px w-400px">
 *   <div>Content...</div>
 * </SynonScrollArea>
 * ```
 */
interface SynonScrollAreaProps extends React.HTMLAttributes<HTMLDivElement> {
...
const SynonScrollArea: React.FC<SynonScrollAreaProps> = ({
  children,
  className,
  direction = 'y',
...
SynonScrollArea.displayName = 'SynonScrollArea';

export default SynonScrollArea;
