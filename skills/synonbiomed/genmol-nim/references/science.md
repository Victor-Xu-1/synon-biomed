...
- Lead optimization by encoding a hit molecule as SAFE and masking a fragment
  to vary.
- Linker and one-step linker design from fixed fragments and attachment points;
  GenMol v2 materially improves one-step linker success relative to v1.
...
- GenMol is ligand/fragment conditioned. Post-generation docking does not make
  the generator pocket conditioned.
