...
export const CAPABILITY_PATTERNS: Record<ModelType, RegExp> = {
  text: /gpt|gemini|qwen|llama|mistral|deepseek/i,
  vision: /4o|gemini-.*-pro|gemini-.*-flash|gemini-2\.0|qwen-vl|llava|vision/i,
  function_calling: /gpt-4|gemini|qwen|deepseek/i,
