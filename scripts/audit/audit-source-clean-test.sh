...
cp "$ROOT_DIR/CONTRIBUTING.md" "$FIXTURE/CONTRIBUTING.md"
cp "$ROOT_DIR/SECURITY.md" "$FIXTURE/SECURITY.md"
cp "$ROOT_DIR/CODE_OF_CONDUCT.md" "$FIXTURE/CODE_OF_CONDUCT.md"
