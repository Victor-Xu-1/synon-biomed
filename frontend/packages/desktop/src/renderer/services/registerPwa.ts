...
export async function registerPwa(): Promise<ServiceWorkerRegistration | undefined> {
  // Vite serves hundreds of source modules. A production service worker that
  // controls this origin serializes and caches every module request, causing
  // very long blank starts and stale-module mixes during development.
