...
export const SETTINGS_VISUAL_CONTRACTS = {
  ...
  skills: contract({
    ...
    primarySelectors: [
      '.settings-page-header__tabs-row',
      '.synon-skill-category-filter',
      '.settings-entity-grid',
      '.settings-entity-card',
    ],
    grid: { desktopColumns: 5, mobileColumns: 1, cardMinHeight: 220 },
    interactionSelectors: [
      '.settings-page-header__tabs [role="tab"]',
      '.settings-page-header__tabs-actions [data-testid="input-search-synon-biomed-skills"]',
      '.settings-page-header__tabs-actions [data-testid="add-skill-button"]',
  ...
  tools: contract({
    ...
    primarySelectors: ['.synon-mcp-grid', '.synon-mcp-card', '.mcp-connector-visual--artwork'],
    grid: { desktopColumns: 4, mobileColumns: 1, cardMinHeight: 220 },
