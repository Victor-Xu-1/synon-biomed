...
- For scaffold, motif, or linker tasks, independently verify that every fixed
  fragment and attachment relationship was retained; `filter: true` is a
  mitigation, not a universal proof.
