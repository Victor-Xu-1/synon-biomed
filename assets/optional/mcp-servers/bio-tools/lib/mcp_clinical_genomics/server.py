...
Open Targets is intentionally served by its official hosted MCP connector;
keeping a second local GraphQL wrapper would create competing tool paths.

Replaces tooluniverse/clingen (8 methods) and tooluniverse/civic (12 methods).
"""
...
mcp = MCPServer("mcp-clinical-genomics")
