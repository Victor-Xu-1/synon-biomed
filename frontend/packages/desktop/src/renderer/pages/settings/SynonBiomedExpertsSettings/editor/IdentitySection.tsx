...
const IdentitySection: React.FC<IdentitySectionProps> = ({
  ...
  return (
    <SectionCard
      title={t('settings.assistantIdentitySection')}
      legend={{
        label: t('settings.assistantEffectiveImmediately'),
        tone: 'now',
      }}
      ...
      <div className='flex items-start gap-14px'>
        {!isIdentityEditable ? (
          ...
          <div className='flex flex-col items-center gap-8px'>
            ...
            <Button
              ...
              className='!rounded-8px !border-arco-2 !bg-base !px-8px !text-11px'
        ...
        <div className='min-w-0 flex-1 space-y-10px'>
          <div className='flex items-center gap-12px'>
            <FieldLabel required>{t('settings.assistantName')}</FieldLabel>
            <Input
              value={editName}
              ...
              className='rounded-8px border-arco-2 bg-base'
            />
          </div>
          <div className='flex items-center gap-12px'>
            <FieldLabel>{t('settings.assistantDescription')}</FieldLabel>
            <Input
