...
export type ConversationRowProps = {
  ...
  onConversationPrefetch: (conversation: TChatConversation) => void;
  ...
  onMove: (conversation: TChatConversation) => void;
  onDelete: (conversation_id: string) => void;
  onExport: (conversation: TChatConversation) => void;
  onDownloadArtifacts: (conversation: TChatConversation) => void;
  onViewNotebook: (conversation: TChatConversation) => void;
