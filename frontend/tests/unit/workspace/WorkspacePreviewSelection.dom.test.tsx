...
vi.mock('@/renderer/pages/conversation/Workspace/hooks/useWorkspaceTree', () => ({
  useWorkspaceTree: () => ({
    ...
    loading: false,
    projectArtifactPage: { query: '', total: 1, hasMore: false, loadingMore: false, loadMoreError: false },
    treeKey: 1,
    expandedKeys: [],
...
vi.mock('@/renderer/pages/conversation/Workspace/components/SynonBiomedArtifactLibrary', () => ({
  default: () => <div data-testid='synon-biomed-artifact-library' />,
}));
