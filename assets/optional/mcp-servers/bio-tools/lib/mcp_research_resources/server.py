"""mcp-research-resources server — MCPServer tools over grants-gov-search + antibody-registry.
...
mcp = MCPServer("mcp-research-resources")
...
def search_grants(
    ...
    Returns:
        {hit_count, n_returned, truncated, records: [{id, number, title,
         ...
         facets?}.
    """
    reject_blank(keyword=keyword, opportunity_number=opportunity_number,
                 aln=aln)
