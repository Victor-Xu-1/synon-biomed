...
def check_nextflow() -> CheckResult:
    ...
    if not shutil.which("nextflow"):
        return CheckResult(
            ...
            fix="Provision a pinned Nextflow package through manage_environments or manage_packages"
        )
        ...
        if match:
            ...
            if major > 23 or (major == 23 and minor >= 4):
                ...
                return CheckResult(
                    ...
                    details=version_line,
                    fix="Create a new governed runtime generation with a supported Nextflow version"
                )
...
def check_java() -> CheckResult:
    ...
    if not shutil.which("java"):
        return CheckResult(
            ...
            fix="Provision Java 11+ through manage_environments or manage_packages"
        )
