      ...
      ...(onSelectionChange
        ? [
            EditorView.updateListener.of((update) => {
              ...
              const start = update.state.doc.lineAt(selection.from);
              const end = update.state.doc.lineAt(selection.to);
              ...
              onSelectionChange({
                ...
                y: coords?.bottom ?? window.innerHeight / 2,
              });
            }),
          ]
        : []),
