...
const workspaceSchemaVersion = 67
...
func schemaMigrationNeedsDedicatedConnection(migration versionedSchemaMigration) bool {
	...
	case kernelSoftwareRuntimeV55CallbackID, kernelBashV56CallbackID:
		return true
	default:
		return false
	}
