...
import AssistantEditorPage from '@/renderer/pages/settings/SynonBiomedExpertsSettings/AssistantEditorPage';
...
vi.mock('@/renderer/pages/settings/SynonBiomedExpertsSettings/AssistantEditorSections', () => ({
