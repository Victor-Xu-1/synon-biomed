...
class BiomartClient:
    ...
    def __init__(
        ...
        *,
        # Keep the worst-case request schedule inside the MCP server's 100s
        # handler budget. The former 120s x3 default made fallback/error
        # handling unreachable and left the host waiting on a dead session.
        timeout: float = 30.0,
        max_retries: int = 1,
