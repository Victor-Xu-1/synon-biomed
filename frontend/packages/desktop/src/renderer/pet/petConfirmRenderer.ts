...
import type { PetConfirmation, PetConfirmationRemovePayload } from '@/common/types/petConfirmation';

const titleEl = document.getElementById('title')!;
const descriptionEl = document.getElementById('description')!;
const optionsEl = document.getElementById('options')!;

let currentConfirmation: PetConfirmation | null = null;
let msgId = '';

/**
 * Render confirmation UI.
 */
function renderConfirmation(confirmation: PetConfirmation): void {
...
window.petConfirmAPI.onConfirmationAdd((data: PetConfirmation) => {
  renderConfirmation(data);
});

window.petConfirmAPI.onConfirmationUpdate((data: PetConfirmation) => {
  renderConfirmation(data);
});

window.petConfirmAPI.onConfirmationRemove((data: PetConfirmationRemovePayload) => {
