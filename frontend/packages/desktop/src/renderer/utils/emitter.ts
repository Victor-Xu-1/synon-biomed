...
interface EventTypes {
  ...
  'synonbiomed.projects.refresh': void;
  'synonbiomed.projects.create': void;
  'synonbiomed.runtime.plan.open': [string];
  'synonbiomed.runtime.reconciled': [string, TConversationRuntimeSummary];
