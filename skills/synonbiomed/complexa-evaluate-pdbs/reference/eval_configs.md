...
- Resource requirements: use the checked backend documentation, live
  local/remote compute snapshot, and a bounded representative PDB. No shared
  hardware file is bundled with this Skill.
